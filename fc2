  function moneypressVer(){ echo "1.0.0";  }
...
$temaReklam[] = array(
    'slug' => 'mp_kat_rek',
	'type' => 'number',
    'label' => __('Konu Listelerinin Arasına Reklam Kodu', 'moneypress')	
);
...
$toc = '<ol class="list-group list-group-numbered mb-3"><span class="list-group-item arka text-white fw-bold" aria-current="true">'.get_option('mp_toc_b').'</span>';
		for ($i =0; $i < $h2Bul; $i++) {
			...
			$toc .=  '<li class="list-group-item"><a href="#'.$h2alt.'">'.$h2Son[1][$i].'</a></li>';
		}
$toc .= '</ol>';
...
class WP_HTML_Compression
{
    ...
    protected function bottomComment($raw, $compressed)
    {
   	 ...
   	 return '<!-- MoneyPress - HTML başarıyla %'.$savings.' oranında sıkıştırıldı. -->';
    }
